...
mcubes.export_obj(vertices1, triangles1, "sphere1.obj")
...
mcubes.export_obj(vertices2, triangles2, "sphere2.obj")
...
try:
    ...
    mlab.triangular_mesh(vertices1[:, 0], vertices1[:, 1], vertices1[:, 2],triangles1)
    print("Done.")
    mlab.show()
except ImportError:
